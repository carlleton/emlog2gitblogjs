!function (a) {
	...
	function h(a) {
		for (var b = o(a) ? 2 : 1; b < a.length; )
			"string" == typeof a[b] ? b + 1 < a.length && "string" == typeof a[b + 1] ? a[b] += a.splice(b + 1, 1)[0] : ++b : (h(a[b]), ++b)
	}
	function i(a, b) {
		function c(a) {
			this.len_after = a,
	...
	m.renderJsonML = function (a, b) {
		...
		if (b.root)
			...
			for (a.shift(), !a.length || "object" != typeof a[0] || a[0]instanceof Array || a.shift(); a.length; )
				c.push(f(a.shift()));
		return c.join("\n\n")
	},
	...
	t = {
		block: {
			...
			lists: function () {
				...
				function c(a, b, c, d) {
					if (b)
						return a.push(["para"].concat(c)), void 0;
						...
						for (var s = f.split(/(?=\n)/), t = "", u = "", v = 0; v < s.length; v++) {
							...
							if (k = w.match(x), void 0 !== k[1]) {
								...
								if (y > n.length)
									...
									z || (y++, y <= n.length ? (n.splice(y, n.length - y), o = n[y - 1].list) : (o = j(k), l.push(o))),
									l = ["listitem"],
									o.push(l)
								}
								u = ""
			...
			blockquote: function (a, b) {
				...
				k = o(j);
				return k && k.references && (delete k.references, r(k) && j.splice(1, 1)),
				c.push(j),
				c
			},
		...
		inline: {
			...
			__call__: function (a, b) {
				...
				for (var d, e = []; a.length > 0; )
					d = this.dialect.inline.__oneElement__.call(this, a, b, e), a = a.substr(d.shift()), q(d, c);
				return e
			},
			"]": function () {},
			"}": function () {},
